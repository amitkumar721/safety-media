...
class ProductController
{
    ...
    public function showAllProduct($start)
    {
        ...
        $limit_offset_url = $url . "items/?start=$start&limit=2";
    ...
    public function createProduct($start = 160)
    {
        ...
        $count = 163;//$getproductfromSpireserver['count'];
        ...
        if ($count > $getStart) {
            ...
            if ($getproductfromSpireserver) {
                ...
                //echo "<pre>";print_r($getProductDetailsFromSpire);die;
            }
            ...
            if ($getProductDetailsFromSpire) {
                $getBigcommerce_requestSchema = makeAndmappshcema($getProductDetailsFromSpire);
            } else {
